 ...
 * gets the most prominent, clearest control. One "Submit for review" action
 * proposes a revision (NEVER writes the registry — the concierge approves).
 *
...
export function ProfileForm({
  ...
  return (
    ...
    >
      ...
      {/* BRANDS — the centerpiece (tri-state relationship) */}
      <fieldset className="portal-fieldset">
        ...
        {initial.brands.length === 0 && (
          <p className="portal-empty">
            No brands listed yet. Your rep can add brands when they review your profile.
          </p>
        )}
