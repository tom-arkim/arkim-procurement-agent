...
export function PendingIntakeView({
  ...
  return (
    <div className={cn("flex flex-1 flex-col overflow-y-auto min-h-0", className)}>
      <div className="flex flex-col items-center justify-center gap-6 p-8 text-center w-full min-h-full">
