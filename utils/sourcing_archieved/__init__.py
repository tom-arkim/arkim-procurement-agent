"""
ARCHIVED — reference only. Do not modify. Will be deleted at the end of the rebuild.
The new procurement agent lives in utils/procurement_agent/.
...
from utils.sourcing_archieved.constants import (           # noqa: E402
    TARGET_VENDORS,
    _VENDOR_DOMAINS,
...
from utils.sourcing_archieved.tier3_outreach import (      # noqa: E402
    draft_rfq_email,
    EMAIL_SEND_ENABLED,
)
from utils.sourcing_archieved.vendor_tokens import (       # noqa: E402
    _onboarding_url,
    _get_vendor_token,
)
...
from utils.sourcing_archieved.llm_parsing import (         # noqa: E402
    _anthropic_complete,
    _llm_parse_results,
)
from utils.sourcing_archieved.price_sanity import (        # noqa: E402
    _apply_price_sanity,
    _sanity_threshold,
    _apply_extreme_price_filter,
)
from utils.sourcing_archieved.market_confidence import (   # noqa: E402
    _fetch_market_confidence,
)
from utils.sourcing_archieved.filtering import (           # noqa: E402
...
from utils.sourcing_archieved.enterprise_search import (   # noqa: E402
...
from utils.sourcing_archieved.orchestrator import (        # noqa: E402
    find_vendors,
)
