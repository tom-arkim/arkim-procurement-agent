...
from utils.sourcing_archieved.vendor_tokens import _get_vendor_token
...
def _build_aftermarket_query(specs: AssetSpecs) -> str:
    ...
    # voltage, rpm, and phase further constrain to compatible units.
    ...
    if getattr(specs, "phase", None):
        parts.append(specs.phase)
...
def _discover_aftermarket_specialists(
    ...
    """
    import utils.sourcing_archieved as _pkg
    from utils.sourcing_archieved.constants import AFTERMARKET_VIABLE_CATEGORIES
